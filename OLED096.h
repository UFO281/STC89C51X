#include<REG52.h> //-----------for STC89C51XX/52XX---
#ifndef _OLED096_H_//头文件开始
#define _OLED096_H_
...
#define Y_WIDTH 	64
//-----------------OLED0.96，IO口定义---------------- 
sbit OLED_SCL=P1^4;//时钟 D0 (SCK)时钟线
sbit OLED_SDIN=P1^3;//D1（data） 数据
...
{0x00,0x00,0x00,0x01,0x01,0x09,0x11,0x21,0xD1,0x09,0x05,0x03,0x00,0x00,0x00,0x00},/*"令",1*/
/* (16 X 16 , 宋体 )*/

{0x04,0x84,0xE4,0x5C,0x44,0xC4,0x02,0xF2,0x12,0x1A,0x96,0x12,0x12,0xF2,0x02,0x00},
{0x02,0x01,0x7F,0x10,0x10,0x3F,0x80,0x4F,0x20,0x18,0x07,0x10,0x20,0xCF,0x00,0x00},/*"硕",2*/
/* (16 X 16 , 宋体 )*/
...
{0x00,0x40,0x20,0x1F,0x20,0x48,0x44,0x42,0x41,0x5F,0x41,0x42,0x44,0x48,0x40,0x00},/*"速",6*/
/* (16 X 16 , 宋体 )*/
...
void main(){
	...
	OLED_Clear();//清屏
	while(1){
		OLED_ShowCHinese(30,0,0);//王 16X16字体(长16像素宽16像素) 在0行 30列显示王字
		OLED_ShowCHinese(48,0,1);//令 0行 48列
		OLED_ShowCHinese(66,0,2);//硕 0行 66列

		OLED_ShowString(0,4,"PWM:");//在0列 4行 显示字符串PWM
		OLED_ShowNum(35,4,pwm,2,16);//显示整数 在35列 4行 16X16字体

		OLED_ShowString(53,4,"%");//在0列 4行 显示字符串 %
